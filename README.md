...
- Summary terlihat berupa sekitar dua kalimat natural tanpa bullet atau label PROS/CONS. Tombol baru tampil jika pertanyaan memuat `**BUY**`/`**BYE**` dan marker `BUYDEE_DECISION_METADATA` berhasil diparse.
